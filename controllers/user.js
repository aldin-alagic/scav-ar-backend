...
export const register = async (req, res) => {
  try {
    ...
    // Add first level for the registered user
    ...
    res.status(400).json({ success: false, message: "Unable to register user! Error: " + error });
  }
};
...
export const resetCode = async (req, res) => {
  try {
    ...
    const msg = {
      to: `${req.body.email}`,
      from: `aldin.alagicc@gmail.com`,
      replyTo: "aldin.alagicc@gmail.com",
      subject: "ScavangerAR - Your password reset code",
      text: `Hello, you've recently requested a password reset. Please use this code in the application for verification before changing the password: ${resetCode} \n Enjoy!\nSincerely, ScavangerAR team`,
      html: `<p>Hello, you've recently requested a password reset. Please use this code in the application for verification before changing the password: ${resetCode} <br> Enjoy!<br>Sincerely, ScavangerAR team</p>`,
    };
